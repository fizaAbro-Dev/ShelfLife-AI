    ...
    <>
      ...
      <section className="mt-8 grid gap-6 lg:grid-cols-3">
        <article className="rounded-3xl bg-white p-6 shadow-sm lg:col-span-2">
          ...
          <p className="mt-2 text-gray-500">
            Your monthly money savings will appear here after backend
            integration.
          </p>
          ...
          <div className="mt-8 flex h-[320px] items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50">
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-500">
                Start adding products to generate reports.
              </p>
            </div>
          </div>
        </article>
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          <article className="rounded-2xl bg-green-50 p-5">
            ...
            <p className="mt-2 text-sm text-gray-600">
              AI will calculate how much food waste you prevented.
            </p>
          </article>
          ...
          <article className="rounded-2xl bg-blue-50 p-5">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Shows how much money you saved by consuming food before expiry.
            </p>
          </article>
          ...
          <article className="rounded-2xl bg-orange-50 p-5">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Displays estimated CO₂ emissions reduced through smarter food
              usage.
            </p>
          </article>
        </div>
